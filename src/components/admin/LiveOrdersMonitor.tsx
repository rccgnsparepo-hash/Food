...
export const LiveOrdersMonitor: React.FC = () => {
  ...
  const getStatusBadge = (status: OrderStatus) => {
    const styles: Partial<Record<OrderStatus, string>> = {
      ...
      payment_confirmed: 'bg-emerald-100 text-emerald-900 border-emerald-300',
      vendor_accepted: 'bg-blue-100 text-blue-900 border-blue-300',
      accepted: 'bg-blue-100 text-blue-900 border-blue-300',
      preparing: 'bg-orange-100 text-orange-900 border-orange-300',
      ready_for_pickup: 'bg-purple-100 text-purple-900 border-purple-300',
      ready: 'bg-purple-100 text-purple-900 border-purple-300',
      rider_assigned: 'bg-indigo-100 text-indigo-900 border-indigo-300',
      assigned: 'bg-indigo-100 text-indigo-900 border-indigo-300',
      rider_arrived_vendor: 'bg-amber-100 text-amber-900 border-amber-300',
      ...
      arrived_at_delivery: 'bg-teal-100 text-teal-900 border-teal-300',
